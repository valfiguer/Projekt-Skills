...
Uso:
    ...
    python3 perfil_mcp.py --dominios pm --url https://mcp.projektrepublic.com/mcp
...
def main() -> int:
    ...
    ap.add_argument("--url", default="https://mcp.projektrepublic.com/mcp", help="base del conector remoto")
